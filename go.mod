...
require (
	...
	github.com/cloudwego/eino-ext/components/document/loader/file v0.0.0-20251011073417-75b93b87b8a9
	github.com/cloudwego/eino-ext/components/document/transformer/splitter/markdown v0.0.0-20251011073417-75b93b87b8a9
	github.com/cloudwego/eino-ext/components/embedding/ark v0.1.0
	github.com/cloudwego/eino-ext/components/indexer/redis v0.0.0-20251011073417-75b93b87b8a9
